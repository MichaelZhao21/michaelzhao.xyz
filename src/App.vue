    ...
    <div class="home">
        <div class="home-top">
            <div id="navbar">
                ...
                <a class="nav-link" href="https://blog.michaelzhao.xyz">blog</a>
            </div>
            ...
            <div id="mobile-navbar" v-bind:class="dropdown ? 'dropdown' : ''">
                ...
                <a class="mobile-nav-link" href="https://blog.michaelzhao.xyz">blog</a>
            </div>
...
import MyTech from './components/MyTech.vue';
